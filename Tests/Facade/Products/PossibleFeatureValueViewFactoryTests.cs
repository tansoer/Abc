...
namespace Abc.Tests.Facade.Products {
    ...
    [TestClass]
    public class PossibleFeatureValueViewFactoryTests : TestsBase {

        [TestInitialize] public void TestInitialize() => type = typeof(PossibleFeatureValueViewFactory);
        ...
        //    var view = GetRandom.ObjectOf<PossibleFeatureValueView>();
        //    view.ValueType = t;
        //    var data = new PossibleFeatureValueViewFactory().Create(view).Data;
        ...
        //    var data = GetRandom.ObjectOf<PossibleFeatureValueData>();
        //    data.Value = create(t);
        //    var view = new PossibleFeatureValueViewFactory().Create(new PossibleFeatureValue(data));

        //    allPropertiesAreEqual(data, view, nameof(data.Value));

        //}
        //private static ValueData create(ValueType t) {
        //    var v = GetRandom.ObjectOf<PossibleFeatureValueView>();
