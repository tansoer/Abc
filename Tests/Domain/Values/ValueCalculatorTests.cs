...
namespace Abc.Tests.Domain.Values {
    [TestClass] public class ValueCalculatorTests :SealedTests<ValueCalculator, Calculate> {
        [TestInitialize] public override void TestInitialize() {
            base.TestInitialize();
            obj = new ValueCalculator();
        }
        ...
        private void test(Operation op, object vA, object vB = null, object vC = null) {
            void doTest(object a, object b, object c = null) {
                var varA = ValueFactory.Create("a", a);
                var varB = ValueFactory.Create("b", b);
                var varC = ValueFactory.Create("c", c);
                obj.Set(varA);
                ...
                obj.Perform(op);
                var actual = obj.Get() as IValue;
                Assert.IsNotNull(actual);
                Assert.IsNotInstanceOfType(actual, typeof(ErrorValue));
